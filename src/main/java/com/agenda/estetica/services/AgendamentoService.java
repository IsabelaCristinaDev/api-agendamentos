...
public class AgendamentoService {
    ...
    public Agendamento salvarAgendamento(Agendamento agendamento) {
        ...
        LocalDateTime horaFim = agendamento.getDataHoraAgendamento()
                .plusMinutes(agendamento.getServico().getDuracaoEstimadaMinutos());

        Agendamento agendados = agendamentoRepository
                .findByFuncionariaAndDataHoraAgendamentoBetween(
                        agendamento.getFuncionaria(),
                        horaAgendamento,
                        horaFim
                );
    ...
    public void deletarAgendamento(LocalDateTime dataHoraAgendamento, Cliente cliente) {
